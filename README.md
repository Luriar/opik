...
| **Phase 2** | EC2/Airflow/Spark/Delta Lake → LLM Gold → 스코어링 → 텔레그램 자동 브리핑 | 설계 완료, 배포 예정 |
| **Phase 3** | 실시간 모니터링, 양방향 QA 챗봇 | 예정 |
...
| 전달 | Telegram Bot (@Luriarbot) HTML 브리핑 |
...
|------|------|-----------|
| **찬호** | 주가 예측 모델 | 주가 데이터 |
| **상용** | DART 공시 수집·분석 | DART Open API |
| **윤준호 + 태주** | 증권사 리포트 수집·가공 | 네이버 금융, 증권사 자체 사이트 |
