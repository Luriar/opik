...
class DailyUpdateStatus:
    ...
    actual_sox_date: str | None = None
    sox_check_enabled: bool = True
    sox_close_present: bool = False
    sox_return_present: bool = False
    sox_return_non_null_count: int = 0
    sox_failure_reason: str | None = None
    ...
    macro_date_policy: str | None = None
    us_market_holiday_detected: bool = False
    us_market_holiday_reason: str | None = None
    ...
    macro_source_actual_dates: dict[str, str] = field(default_factory=dict)
    macro_source_expected_dates: dict[str, str] = field(default_factory=dict)
