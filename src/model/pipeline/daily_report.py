...
def generate_daily_top10_report(
    ...
    write_daily_summary(enriched, top10, output_paths["summary"], warnings)
...
def write_daily_summary(enriched: pd.DataFrame, top10: pd.DataFrame, path: Path, warnings: list[str]) -> None:
