...
def generate_daily_predictions(
    ...
    # Upload Gold predictions to S3 for OPIK Briefing DAG (Phase 2 integration).
    compact_date = pd.Timestamp(prediction_date).strftime("%Y%m%d")
    s3_key = upload_gold_predictions(predictions, compact_date)
