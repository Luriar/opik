import json, io, boto3, pyarrow.parquet as pq
...
print("Processing {} files, {} unique ids".format(len(keys), len(unique_ids)))
...
for i, key in enumerate(keys):
    ...
    if (i + 1) % 20 == 0:
        print("  {}/{} files, {} infos".format(i + 1, len(keys), len(all_info)))
